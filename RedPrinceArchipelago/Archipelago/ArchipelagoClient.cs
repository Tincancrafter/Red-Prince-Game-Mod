...
public class ArchipelagoClient
{
    ...
    private const string Game = "Red Prince";
    ...
    public void Connect()
    {
        ...
        ArchipelagoConsole.SetConnectionStatus("Connecting...", false);
        try
        {
    ...
    private void HandleConnectResult(LoginResult result)
    {
        ...
        if (result.Successful)
        {
            ...
            Authenticated = true;
            ArchipelagoConsole.SetConnectionStatus($"Connected as {ServerData.SlotName}", false);
        ...
        else
        {
            ...
            string details = result is LoginFailure failure
                ? string.Join(" ", failure.Errors)
                : "The server rejected the connection.";
            ArchipelagoConsole.SetConnectionStatus(details, true);
