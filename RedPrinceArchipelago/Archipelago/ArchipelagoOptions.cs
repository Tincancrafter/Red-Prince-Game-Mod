...
public static class ArchipelagoOptions
{
    ...
    /// <summary>
    /// When true, Outer Room drafts use received Archipelago rooms.
    /// </summary>
    public static bool OuterRoomDraftSanity { get; private set; } = true;
    ...
    public static void LoadFromSlotData(SlotData slotData)
    {
        ...
        try
        {
            ...
            OuterRoomDraftSanity = slotData.OuterRoomDraftSanity;
    ...
    public static void LoadFromDictionary(Dictionary<string, object> slotData)
    {
        ...
        try
        {
            ...
            OuterRoomDraftSanity = GetBool(slotData, "outer_room_draft_sanity", true);
    ...
    public static void LogOptions()
    {
        ...
        Logging.Log($"  OuterRoomDraftSanity: {OuterRoomDraftSanity}");
